...
'''
Yuz Tespiti1.2 'e yapilna guncellemeler:

1-)durdrma kontrolu(sel_run_flag)
2-)GUI zaten PyQt ile yapildigi icin 'waitkey' ve 'destroyyallwindow' fonksiyonlarini kaldirildi
